...
public class RedisUtils {
    ...
    public static <T> void setStringValue(String key, T value) {
        if (key != null && value != null) {
            valueOperations.set(getKey(key), value);
        }
    }

    public static Object getValue(String originKey) {
        return valueOperations.get(originKey);
    }
    ...
    public static <T> void setStringValue(String key, T value, long expire) {
        if (key != null && value != null) {
    ...
    public static Set<String> getPatternKeys(String keyPattern) {
        return innerTemplate.keys(keyPattern);
    }
    ...
    public static void putHash(String key, Object hashKey, Object hashValue) {
        validKey(key);
    ...
    public static Long increment(String key, Object hashKey, Integer increment) {
        validKey(key);
        Assert.notNull(hashKey, "hashKey must not be null!");
